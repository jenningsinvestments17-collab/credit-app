...
function getStepStyles(status: ClientDashboardViewModel["journeySteps"][number]["status"]) {
  if (status === "complete") {
...
export function JourneyStepsPanel({ model }: { model: ClientDashboardViewModel }) {
  return (
