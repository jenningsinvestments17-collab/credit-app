...
export function RevenueQueueTable({ model }: { model: AdminDashboardViewModel }) {
  return (
      ...
      <div className="mt-6 overflow-hidden rounded-[1.2rem] border border-white/10">
        ...
        <div className="grid divide-y divide-white/10">
          {model.revenueQueue.length ? (
            model.revenueQueue.map((item) => (
              <div key={item.disputeId} className="grid gap-4 bg-white/[0.03] px-4 py-4 md:grid-cols-[1.2fr_0.7fr_0.7fr_1fr] md:items-center">
